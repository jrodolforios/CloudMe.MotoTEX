...
namespace CloudMe.Auth.Admin.Controllers
{
    ...
    public class IdentityController : BaseIdentityController<CloudMeMotoTEXContext, CloudMeUserDto, Guid, RoleDto<Guid>, Guid, Guid, Guid, CloudMe.MotoTEX.Infraestructure.Entries.Usuario,IdentityRole<Guid>, Guid, IdentityUserClaim<Guid>, IdentityUserRole<Guid>,  IdentityUserLogin<Guid>,IdentityRoleClaim<Guid>, IdentityUserToken<Guid>>
    {
        public IdentityController(IIdentityService<CloudMeMotoTEXContext, CloudMeUserDto, Guid, RoleDto<Guid>, Guid, Guid, Guid, CloudMe.MotoTEX.Infraestructure.Entries.Usuario,IdentityRole<Guid>, Guid, IdentityUserClaim<Guid>, IdentityUserRole<Guid>,  IdentityUserLogin<Guid>,IdentityRoleClaim<Guid>, IdentityUserToken<Guid>> identityService, ILogger<ConfigurationController> logger, IStringLocalizer<IdentityController> localizer)
