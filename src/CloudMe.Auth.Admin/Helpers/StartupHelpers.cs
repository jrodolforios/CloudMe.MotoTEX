...
using CloudMe.Auth.Admin.Middlewares;
using CloudMe.Auth.Admin.Configuration;
...
namespace CloudMe.Auth.Admin.Helpers
{
    public static class StartupHelpers
    {
        ...
        public static void AddAuthenticationServices<TContext, TUser, TUserRole>(this IServiceCollection services, IHostingEnvironment hostingEnvironment, IAdminConfiguration adminConfiguration)
            where TContext : DbContext where TUser : class where TUserRole : class
        {
