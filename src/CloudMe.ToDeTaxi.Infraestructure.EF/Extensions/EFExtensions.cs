...
namespace CloudMe.ToDeTaxi.Infraestructure.EF.Extensions
{
    ...
    public static class EFExtensions
    {
        ...
        public class SprocResults
        {
            ...
            public T ReadToValue<T>() where T : class
            {
            ...
            /// </summary>
            private T MapToValue<T>(DbDataReader dr) where T : class
            {
                if (dr.HasRows)
                {
                    if (dr.Read())
                    {
                        return dr.IsDBNull(0) ? null : dr.GetFieldValue<T>(0);
                    }
                }
                return null;
            }
