...
using CloudMe.MotoTEX.Configuration;
using Serilog;
...
namespace CloudMe.MotoTEX
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthenticationServices<CloudMeMotoTEXContext, CloudMe.MotoTEX.Infraestructure.Entries.Usuario, IdentityRole<Guid>>(Environment, Configuration, Logger);
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, CloudMeMotoTEXContext CloudMeMotoTEXContext)
        {
            //app.AddLogging(loggerFactory, Configuration);

            Log.Logger = new LoggerConfiguration()
                            .WriteTo.File(AppDomain.CurrentDomain.BaseDirectory + "/Logs/CLOUDME_MotoTEX_AUTH_.log", rollingInterval: RollingInterval.Day, retainedFileCountLimit: null)
                            .CreateLogger();
